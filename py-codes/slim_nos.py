...
if __name__ == "__main__":
    ...
    # yayin
    bx_train = '0302_yayin_train.txt'   #  '0226_yayin_train.txt'
    bx_test = '0302_yayin_test.txt'    #  '0226_yayin_test.txt'
    txt_out_dir = '/data/home/jiachen/project/seg_project/seg_2022/hebi/project/exps/classify_cls2/overlap_3072/3072_slim'


    # 控制train, test中, no:yes的比例.
    no2yes = [2, 1]
    slimed_nos_train_txt = os.path.join(txt_out_dir, '3072yayin_no{}yes_train.txt'.format(no2yes[0]))
    slimed_nos_test_txt = os.path.join(txt_out_dir, '3072yayin_no{}yes_test.txt'.format(no2yes[1]))
