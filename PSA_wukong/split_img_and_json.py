...
def split_image(json_path, path_image, split_target,out_dir=None, roi=None):
    res_js_path = '/data/home/jiachen/data/seg_data/hebi/seg_yayin_json'
...
def split_img_dir(source_path,json_path,split_target,out_dir=None,roi=None):
    for root,dirs,files in os.walk(source_path):
        for filename in files:
            ...
            if ext in ('.jpg', '.jpeg', '.png', '.ppm', '.bmp', '.pgm', '.tif', '.tiff', '.webp'):
                ...
                split_image(json_path,os.path.join(root,filename),split_target,tmp_dir_out,roi)
...
if __name__ == "__main__":
    ...
    # 切好一半后的masked_ins, 再走json+img切割.
    source_path = '/data/home/jiachen/data/seg_data/hebi/mask_yayin_2bins'
    json_dir = '/data/home/jiachen/data/seg_data/hebi/json_yayin'
