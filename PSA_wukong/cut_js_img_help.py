...
def split_image(json_path, path_image, split_target,res_js_path,out_dir=None, roi=None):
...
def split_img_dir(source_path,json_path,split_target,res_js_path,out_dir=None,roi=None):
    for root,dirs,files in os.walk(source_path):
        for filename in files:
            ...
            if ext in ('.jpg', '.jpeg', '.png', '.ppm', '.bmp', '.pgm', '.tif', '.tiff', '.webp'):
                ...
                split_image(json_path,os.path.join(root,filename),split_target,res_js_path, tmp_dir_out, roi)


def help(source_path, json_dir, res_js_path, out_dir, split_target):
    split_img_dir(source_path, json_dir, split_target,res_js_path,out_dir)
