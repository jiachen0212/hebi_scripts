...
if __name__ == "__main__":
    ...
    root_path = '/Users/chenjia/Downloads/Learning/SmartMore/2022/DL/hebi/model_for_工程/0307/工位3-seg-2bins_0314'
    onnx_path = os.path.join(root_path, '5000.onnx')
    ...
    test_dir = '/Users/chenjia/Desktop/hx_yy_imgs'
    res_dir = '/Users/chenjia/Desktop/hx_yy_imgs_res'
    ...
    for test_path in test_paths:
        ...
        for ind, img in enumerate([img_left, img_right]):
            ...
            if points:
                ...
                # cv2.waitKey(10000)
                if ind == 0:
                    res_img[:h, :w//2, :] += img_save
                else:
                    res_img[:h, w//2:, :] += img_save
            else:
                print("no yayin_heixian defect")

        cv2.imwrite(os.path.join(res_dir, im_name), res_img)
