...
if __name__ == "__main__":
    ...
    '''
    # roi = (2500, 0, 6000, 8192)  # (left, upper, right, lower)

    # 裁剪单张图像
    # path_image = r"D:\Work\projects\shiyu_极片涂敷\demo_image\3076__2021-10-24 06-36-19-740第299条EA.jpg"   # 填写图像地址，具体到图像名称和后缀
    # split_target = (8,8) # 这个图像裁剪成多少分，分别对应高度和宽度
    # split_image(path_image, split_target)


    roi = (0, 200, 5472, 3648)
    # 裁剪目录（包含子目录）下面的全部图像
    source_path = '/Users/chenjia/Desktop/1' # 填写图像&标注所在目录
    out_dir = '/Users/chenjia/Desktop/1_split'  # 填写裁剪后图像输出目录
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)

    split_target = (6, 3) # 这个图像裁剪成多少分，分别对应宽度和高度
