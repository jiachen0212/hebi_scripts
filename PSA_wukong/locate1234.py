...
def main1(paths):
    import glob
    path = "/data/home/jiachen/data/seg_data/hebi/20220214/imgs/hebi_label/1/1.png"
    train_image = cv2.imread(path, 0)
    conf_path = "/data/home/jiachen/data/seg_data/hebi/20220214/imgs/hebi_label/1/1.json"
    ...
    for cur_path in paths:
        print(cur_path)
        save_path = "{}masked{}".format(cur_path.split('PSA')[0], cur_path.split('PSA')[1])
        if not os.path.exists(os.path.dirname(save_path)):
            os.makedirs(os.path.dirname(save_path))
        # /data/home/jiachen/data/seg_data/hebi/20220303/imgs/PSA/3cls/loubai/1/20220303_100145301_NG.png
        try:
...
def main3(paths):
    import glob
    path = "/data/home/jiachen/data/seg_data/hebi/20220214/imgs/hebi_label/2/2.png"
    train_image = cv2.imread(path, 0)
    conf_path = "/data/home/jiachen/data/seg_data/hebi/20220214/imgs/hebi_label/2/2.json"
    with open(conf_path) as f:
        train_conf = json.load(f)
...
def main4(paths):
    import glob
    path = "/data/home/jiachen/data/seg_data/hebi/20220214/imgs/hebi_label/3/3.png"
    train_image = cv2.imread(path, 0)
    conf_path = "/data/home/jiachen/data/seg_data/hebi/20220214/imgs/hebi_label/3/3.json"
    with open(conf_path) as f:
        train_conf = json.load(f)
...
def locate_fun(dir1, dir2, dir3, dir4):
    main1(dir1)
    main2(dir2)
    main3(dir3)
    main4(dir4)
